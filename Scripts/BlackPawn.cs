...
public class BlackPawn : MonoBehaviour
{
    ...
    // Define the direction in which the pawn is allowed to move (forward along the negative Z-axis)
    ...
    {
        // Find the squares in the allowed move direction behind the selected pawn
